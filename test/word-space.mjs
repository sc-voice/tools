...
const MN8_NOE = {
	...
	'mn8:1.2':
		'À une époque, le Bouddha séjournait près de Sāvatthī dans le Bosquet de Jeta, au monastère d’Anāthapiṇḍika. ',
	'mn8:2.1':
		'Vers le soir, le Vénérable Mahācunda quitta sa retraite méditative et se dirigea vers le Bouddha. Après l’avoir respectueusement salué, il prit place à ses côtés et s’adressa ainsi au Bouddha : ',
	'mn8:3.1':
		'« Vénérable, de nombreuses croyances surgissent dans le monde, ',
	'mn8:3.2':
		'liées à des doctrines du soi ou à des conceptions du cosmos. ',
	'mn8:3.3':
	...
	'mn8:3.4':
		'« Cunda, de nombreuses croyances surgissent dans le monde, ',
	'mn8:3.5':
		'liées à des doctrines du soi ou à des conceptions du cosmos. ',
	'mn8:3.6':
	...
	'mn8:4.1':
		'Il se peut qu’un monastique, détaché des plaisirs sensoriels et des états nuisibles, puisse entrer et demeurer dans la première absorption, empreinte de joie et de bien-être nés de la solitude, tout en focalisant son esprit et le maintenant engagé. ',
	'mn8:4.2': 'Il pourrait penser ',
	'mn8:4.3': 'qu’il pratique l’effacement de soi. ',
	'mn8:4.4':
		'Cependant, dans la discipline du Noble, cela n’est pas désigné comme ‹ l’effacement de soi › ; ',
	'mn8:4.5':
		'cela est qualifié de ‹ méditation bienheureuse dans la vie présente ›. ',
};
const MN8_MOHAN = [
